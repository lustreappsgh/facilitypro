...
test('maintenance request todo and inspection week labels start on monday', function () {
    ...
    expect($maintenanceRequest->fresh()->month_week)->toBe('February wk 4 (Feb 23 - Mar 01)');
