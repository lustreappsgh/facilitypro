...
onMounted(() => {
    ...
    router.get(maintenanceOversight().url, {
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
            <PageHeader
                title="Maintenance oversight"
                subtitle="Read-only visibility into request health and costs."
            ...
            <div class="space-y-4">
                <form
                    v-if="filtersVisible"
                    :action="maintenanceOversight().url"
                    method="get"
                ...
                >
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <Button variant="ghost" as-child>
                                <Link :href="maintenanceOversight().url">Reset</Link>
                            </Button>
                        </div>
                </form>
