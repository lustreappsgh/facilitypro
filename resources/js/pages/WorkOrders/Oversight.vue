...
import { oversight as workOrdersOversight, show } from '@/routes/work-orders';
...
const columns: ColumnDef<WorkOrder>[] = [
    ...
    },
    {
        ...
        header: 'Facility',
        cell: ({ row }) => row.original.maintenanceRequest?.facility?.name ?? '--',
    },
    {
        id: 'vendor',
            ...
            >
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Button variant="ghost" as-child>
                        <Link :href="workOrdersOversight().url">Reset</Link>
                    </Button>
                </div>
                    </form>
                </template>
