...
onMounted(() => {
    ...
    router.get(inspectionsAdmin().url, {
...
const columns: ColumnDef<Inspection>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) =>
            h(
                Badge,
                { variant: 'secondary', class: conditionBadgeClass(row.original.condition) },
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
            ...
            <div class="space-y-4">
                ...
                <input type="hidden" name="inspector" :value="inspectorFilter" />
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <Button variant="outline" class="min-w-[180px] justify-between">
