...
const goToPrevious = () => {
    ...
    router.get(
        props.serverPagination.prevUrl,
        {},
        {
            preserveState: true,
            preserveScroll: true,
...
const goToNext = () => {
    ...
    router.get(
        props.serverPagination.nextUrl,
        {},
        {
            preserveState: true,
            preserveScroll: true,
...
<template>
    <div class="flex flex-col gap-4">
        ...
        >
            ...
            <div
                v-if="$slots.footer"
                class="border-t border-border/60 bg-muted/10"
            >
        ...
        <div
            v-if="
                (showSelectionSummary && enableRowSelection) || showPagination
            "
            class="flex flex-wrap items-center justify-between gap-3"
        >
            <div
                v-if="showSelectionSummary && enableRowSelection"
