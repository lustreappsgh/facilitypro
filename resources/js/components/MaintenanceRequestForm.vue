...
const submitText = computed(() => props.submitLabel ?? 'Submit request');
...
<template>
    <div class="space-y-6">
        ...
        <div class="grid gap-2">
            ...
            <Select v-model="requestTypeSelection" name="request_type_id" required>
                <SelectTrigger id="request_type_id" class="w-full">
                    <SelectValue placeholder="Select a type" />
                </SelectTrigger>
                <SelectContent>
                    <SelectItem v-for="type in requestTypes" :key="type.id" :value="String(type.id)">
                        {{ type.name }}
                    </SelectItem>
                </SelectContent>
            </Select>
        ...
        <div class="grid gap-2">
            ...
            <Input id="cost" name="cost" type="number" step="1" placeholder="0" />
