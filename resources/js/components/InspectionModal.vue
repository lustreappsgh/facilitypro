        ...
        <DialogContent class="max-w-2xl">
            <DialogHeader>
                ...
                <DialogDescription class="text-xs font-bold uppercase tracking-widest text-muted-foreground/60">
                    Record facility conditions and operational status
                </DialogDescription>
            </DialogHeader>
            ...
            <Tabs v-model="activeTab" class="w-full">
                ...
                <TabsContent value="single">
                    <Form v-bind="formConfig" @success="handleSuccess" #default="{ errors, processing }">
                        ...
                        <InspectionForm :facilities="facilities" :conditions="conditions" :errors="errors"
                            ...
                            cancel-href="#" submit-label="Submit Inspection" />
                    </Form>
                </TabsContent>
                ...
                <TabsContent value="bulk">
                    <Form v-bind="formConfig" @success="handleSuccess" #default="{ errors, processing }">
                        ...
                        <InspectionForm :facilities="facilities" :conditions="conditions" :errors="errors"
                            ...
                            :selected-facility-ids="selectedFacilityIds" :show-cancel="true" :on-cancel="handleClose"
                            cancel-href="#" submit-label="Submit Bulk Inspection" />
                    </Form>
                </TabsContent>
            </Tabs>
        </DialogContent>
